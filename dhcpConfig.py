...
class DhcpdGlobalConfig:
    ...
    def to_string(self) -> str:
        ...
        if self.port:
            configs.append(f"DHCPD_INTERFACE={self.port};")
...
class DhcpConfig:
    _global_config: DhcpdGlobalConfig
    ...
    def add_global(self, port: str) -> None:
...
def configure_dhcpd(node: NodeConfig, port: str = None) -> None:
